                    ...
                    <Container className="d-flex mt-4 p-4"> 
                        <div className={styles.about__card__big}>
                            <div className="mb-4"> 
                                <div className="row g-0"> 
                                <div className="col-md-3 d-flex flex-column align-items-center">
                                    <Image src={nastya__hobby} className={`mb-3 ${styles.custom__margin}`} alt="polina's hobbies" style={{marginTop: '-30px'}} fluid />
                                    <Image src={nastya__fashion} className={`mb-3 ${styles.custom__margin}`} alt="polina's sertificate" fluid />
                                </div>
